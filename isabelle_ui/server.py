...
from prover.isabelle_api import start_isabelle_server, get_isabelle_client, session_id_from_start
...
SESSION = session_id_from_start(isabelle.session_start(session="HOL"))
