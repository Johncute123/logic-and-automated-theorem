...
from .isabelle_api import start_isabelle_server, get_isabelle_client, session_id_from_start
...
def cmd_bench(args: argparse.Namespace) -> None:
    ...
    session_id = session_id_from_start(isabelle.session_start(session="HOL"))
